...
Phase 4 [PR #3](https://github.com/dsbowersock/atmoshaper/pull/3) and Phase 5 [PR #4](https://github.com/dsbowersock/atmoshaper/pull/4) are merged. Phase 6 is being delivered as smaller dependency-ordered replacements for preserved [PR #5](https://github.com/dsbowersock/atmoshaper/pull/5). Replacement PRs #6–#12 remain open and unmerged after completing their individual exact-head review and CI gates. [PR #13](https://github.com/dsbowersock/atmoshaper/pull/13) is the active Task 8 legal-identity replacement. Successive hosted and local review rounds exposed verified server-session, public-session and deterministic-clock boundary findings; the final product amendment passed provider-free validation, independent SPEC and separate QUALITY before publication as `2ab6382d2e944b75e8eb0e76808870f205d21736`. GitHub and the ignored review handoff are authoritative for the resulting current head, hosted-review and strict-CI status; exact-head coverage from both reviewers and every required CI job remains mandatory before any merge decision.
