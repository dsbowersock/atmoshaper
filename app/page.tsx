    ...
    <AppPageShell width="full" className="pt-0 sm:pt-0 lg:pt-0" contentClassName="gap-8">
      <section className="grid gap-8 pb-4 pt-px lg:grid-cols-[minmax(0,1.05fr)_minmax(18rem,0.55fr)] lg:items-center lg:py-8">
        <div className="min-w-0 [container-type:inline-size]">
          {/* At lg widths, size the nowrap product name from its grid column, not the viewport. */}
          <h1
            className="mb-1 inline-block max-w-full overflow-visible whitespace-nowrap pt-1 text-5xl font-semibold leading-none tracking-tight text-foreground sm:pt-2 sm:text-7xl lg:text-[clamp(3rem,16cqi,6rem)]"
