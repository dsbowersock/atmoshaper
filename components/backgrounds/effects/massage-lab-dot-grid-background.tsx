...
import type { BackgroundEffectProps, MassageLabDotGridOptions } from "./css-backgrounds"
...
const DEFAULT_MASSAGELAB_DOT_GRID: ResolvedDotGridOptions = {
  dotSize: 16,
  gap: 32,
  baseColor: "#5227FF",
  activeColor: "#5227FF",
...
export default function MassageLabDotGridBackground({
  ...
  return (
    <div className={cn(styles.massageLabDotGrid, className)} aria-hidden="true">
      <canvas ref={canvasRef} className={styles.massageLabDotGridCanvas} />
    </div>
  )
}

function resolveDotGridOptions(options: MassageLabDotGridOptions | undefined): ResolvedDotGridOptions {
  return {
    dotSize: resolveNumber(options?.dotSize, DEFAULT_MASSAGELAB_DOT_GRID.dotSize, 2, 40),
    gap: resolveNumber(options?.gap, DEFAULT_MASSAGELAB_DOT_GRID.gap, 4, 80),
    baseColor: resolveHex(options?.baseColor, DEFAULT_MASSAGELAB_DOT_GRID.baseColor),
    activeColor: resolveHex(options?.activeColor, DEFAULT_MASSAGELAB_DOT_GRID.activeColor),
    proximity: resolveNumber(options?.proximity, DEFAULT_MASSAGELAB_DOT_GRID.proximity, 40, 500),
    speedTrigger: resolveNumber(options?.speedTrigger, DEFAULT_MASSAGELAB_DOT_GRID.speedTrigger, 0, 1000),
    shockRadius: resolveNumber(options?.shockRadius, DEFAULT_MASSAGELAB_DOT_GRID.shockRadius, 40, 700),
    shockStrength: resolveNumber(options?.shockStrength, DEFAULT_MASSAGELAB_DOT_GRID.shockStrength, 0, 12),
    maxSpeed: resolveNumber(options?.maxSpeed, DEFAULT_MASSAGELAB_DOT_GRID.maxSpeed, 100, 8000),
