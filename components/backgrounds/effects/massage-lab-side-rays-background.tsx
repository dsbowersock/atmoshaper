...
// AtmoShaper Side Rays ships as an OGL full-screen shader. AtmoShaper keeps
...
function getUniformLocation(
  ...
  if (!location) {
    throw new Error(`Missing ${PUBLIC_PRODUCT_IDENTITY.name} Side Rays shader uniform: ${name}`)
  }
