...
import type { BackgroundEffectProps, MassageLabDotFieldOptions } from "./css-backgrounds"
...
type ResolvedDotFieldOptions = Required<MassageLabDotFieldOptions>
...
function resolveDotFieldOptions(options: MassageLabDotFieldOptions | undefined): ResolvedDotFieldOptions {
  return {
    dotRadius: resolveNumber(options?.dotRadius, DEFAULT_MASSAGELAB_DOT_FIELD.dotRadius, 0.5, 8),
    dotSpacing: resolveNumber(options?.dotSpacing, DEFAULT_MASSAGELAB_DOT_FIELD.dotSpacing, 4, 48),
    cursorRadius: resolveNumber(options?.cursorRadius, DEFAULT_MASSAGELAB_DOT_FIELD.cursorRadius, 60, 900),
    cursorForce: resolveNumber(options?.cursorForce, DEFAULT_MASSAGELAB_DOT_FIELD.cursorForce, 0.01, 1),
    bulgeOnly: options?.bulgeOnly ?? DEFAULT_MASSAGELAB_DOT_FIELD.bulgeOnly,
    bulgeStrength: resolveNumber(options?.bulgeStrength, DEFAULT_MASSAGELAB_DOT_FIELD.bulgeStrength, 0, 160),
    glowRadius: resolveNumber(options?.glowRadius, DEFAULT_MASSAGELAB_DOT_FIELD.glowRadius, 0, 360),
    sparkle: options?.sparkle ?? DEFAULT_MASSAGELAB_DOT_FIELD.sparkle,
    waveAmplitude: resolveNumber(options?.waveAmplitude, DEFAULT_MASSAGELAB_DOT_FIELD.waveAmplitude, 0, 48),
    gradientFrom: resolveCssColor(options?.gradientFrom, DEFAULT_MASSAGELAB_DOT_FIELD.gradientFrom),
    gradientTo: resolveCssColor(options?.gradientTo, DEFAULT_MASSAGELAB_DOT_FIELD.gradientTo),
    glowColor: resolveHex(options?.glowColor, DEFAULT_MASSAGELAB_DOT_FIELD.glowColor),
    cursorInteraction: options?.cursorInteraction ?? DEFAULT_MASSAGELAB_DOT_FIELD.cursorInteraction,
  }
}
