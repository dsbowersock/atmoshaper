...
export default function MassageLabSparklesBackground({
  ...
  return (
    <div
      className={cn(styles.effectLayer, styles.massageLabSparklesLayer, hasLoaded && styles.massageLabSparklesLoaded, className)}
      aria-hidden="true"
    >
      <ParticlesProvider init={initSparklesParticles}>
        <Particles
          id={particleId}
          className={styles.massageLabSparklesCanvas}
          options={options}
