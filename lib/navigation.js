 ...
 * @typedef {"USER" | "STUDENT" | "LICENSED_THERAPIST" | "CLIENT" | "EDITOR" | "ANATOMY_ADMIN" | "ANATOMY_REVIEWER" | "ANATOMY_EDITOR" | "ADMIN"} NavigationAccountRole
...
export const navigationGroups = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        id: "business-break-even-planner",
  ...
  {
    id: "atmosphere",
    label: ATMOSPHERE_PUBLIC_LABELS.name,
    routes: [
      {
        id: "music",
        href: "/music",
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        id: "about-project",
        href: "/about",
        label: `About ${PUBLIC_PRODUCT_IDENTITY.name}`,
        icon: "Info",
        audiences: allAudiences,
        visibleInSidebar: true,
        groupId: "about",
    ...
    routes: [
      {
        ...
        groupId: "admin",
        auth: "signed-in",
        accountRoles: ["ANATOMY_REVIEWER", "ANATOMY_EDITOR", "ADMIN"],
      },
      {
        id: "admin-anatomy",
        href: "/admin/anatomy",
        ...
        groupId: "admin",
        auth: "signed-in",
        accountRoles: ["ANATOMY_EDITOR", "ADMIN"],
      },
      {
