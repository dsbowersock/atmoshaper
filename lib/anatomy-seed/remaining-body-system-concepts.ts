...
const CONCEPTS: ConceptSpec[] = [
  ...
  { id: "concept-stress-response", slug: "stress-response", name: "Stress Response", conceptType: "system_function", bodySystem: "endocrine", description: "The stress response includes nervous and endocrine changes that help the body respond to challenge. AtmoShaper keeps this at general physiology level and avoids treatment claims.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  ...
  { id: "concept-pregnancy-support", slug: "pregnancy-support", name: "Pregnancy Support", conceptType: "system_function", bodySystem: "reproductive", description: "Pregnancy support describes broad reproductive-system changes that support development before birth. AtmoShaper stores it as non-diagnostic A&P context only.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  ...
  { id: "concept-nociception", slug: "nociception", name: "Nociception", conceptType: "system_function", bodySystem: "nervous", description: "Nociception is nervous-system detection of potentially harmful stimuli. AtmoShaper uses the concept carefully for education and SOAP language, not pain diagnosis.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR, terms: [{ term: "pain signaling", termType: "common" }] },
