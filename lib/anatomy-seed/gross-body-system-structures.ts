...
const TEXTBOOK_TAXONOMY_SOURCE = "openstax-anatomy-physiology"
const BODY_SYSTEM_LOCATOR = "OpenStax Anatomy and Physiology 1.2 structural organization and organ-system review source; MassageLab-authored summary."
const TISSUE_TYPE_LOCATOR = "OpenStax Anatomy and Physiology 4.1 tissue-type review source; MassageLab-authored summary."
...
const SKELETAL_SYSTEM_CONCEPT: AnatomyConcept = {
  id: "concept-skeletal-system",
  slug: "skeletal-system",
  name: "Skeletal System",
  conceptType: "system_structure",
  bodySystem: "skeletal",
  description: "The skeletal system includes bones, cartilage, joints, and supporting connective tissues that provide structure, protection, leverage, and mineral storage.",
  sourceRef: TEXTBOOK_TAXONOMY_SOURCE,
}

const MUSCULAR_SYSTEM_CONCEPT: AnatomyConcept = {
  id: "concept-muscular-system",
  slug: "muscular-system",
  name: "Muscular System",
  conceptType: "system_structure",
  bodySystem: "muscular",
  description: "The muscular system includes skeletal muscles and related contractile tissues that create movement, support posture, and produce force.",
  sourceRef: TEXTBOOK_TAXONOMY_SOURCE,
}

const BODY_SYSTEM_CONCEPTS = [
  MUSCULOSKELETAL_SYSTEM_CONCEPT,
  SKELETAL_SYSTEM_CONCEPT,
  MUSCULAR_SYSTEM_CONCEPT,
]

const TISSUE_TYPE_CONCEPTS: AnatomyConcept[] = [
  {
    id: "concept-epithelial-tissue",
  ...
  {
    id: "concept-connective-tissue",
    slug: "connective-tissue",
    name: "Connective Tissue",
    conceptType: "tissue_type",
    description: "Connective tissue supports, protects, binds, and integrates body structures. This taxonomy target covers fascia, tendons, ligaments, cartilage, bone, adipose, blood, lymph, and related connective structures.",
    sourceRef: TEXTBOOK_TAXONOMY_SOURCE,
  },
  {
    id: "concept-muscle-tissue",
    slug: "muscle-tissue",
    name: "Muscle Tissue",
    conceptType: "tissue_type",
    description: "Muscle tissue contracts to produce force and movement. This tissue-type target covers skeletal muscle tissue plus broader muscle tissue concepts used in A&P education.",
    sourceRef: TEXTBOOK_TAXONOMY_SOURCE,
  },
  {
    id: "concept-nervous-tissue",
    slug: "nervous-tissue",
    name: "Nervous Tissue",
    conceptType: "tissue_type",
    description: "Nervous tissue detects, processes, and transmits information through neurons and supporting cells. It is modeled separately from the nervous organ system.",
    sourceRef: TEXTBOOK_TAXONOMY_SOURCE,
  },
]
...
const STRUCTURES: StructureSpec[] = [
  ...
  { id: "structure-blood", slug: "blood", name: "Blood", structureType: "fluid_connective_tissue", region: "trunk-spine-pelvis", systemSlug: "cardiovascular", systemConceptSlug: "cardiovascular-system", description: "Blood is the circulating fluid connective tissue of the cardiovascular system. It gives the system browser a clear structure for transport, oxygen delivery, and tissue-type classification.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "circulating blood", termType: "common" }, { term: "fluid connective tissue", termType: "clinical" }] },
  { id: "structure-right-atrium", slug: "right-atrium", name: "Right Atrium", structureType: "heart_chamber", region: "thorax", systemSlug: "cardiovascular", systemConceptSlug: "cardiovascular-system", description: "The right atrium is a heart chamber that receives systemic venous blood before it moves toward the right ventricle. It adds basic chamber anatomy to the cardiovascular system.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "right atrial chamber", termType: "clinical" }] },
  { id: "structure-right-ventricle", slug: "right-ventricle", name: "Right Ventricle", structureType: "heart_chamber", region: "thorax", systemSlug: "cardiovascular", systemConceptSlug: "cardiovascular-system", description: "The right ventricle is a heart chamber that pumps blood toward the pulmonary circulation. It supports introductory heart-flow and cardiovascular anatomy education.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "right ventricular chamber", termType: "clinical" }] },
  { id: "structure-left-atrium", slug: "left-atrium", name: "Left Atrium", structureType: "heart_chamber", region: "thorax", systemSlug: "cardiovascular", systemConceptSlug: "cardiovascular-system", description: "The left atrium is a heart chamber that receives pulmonary venous blood before it moves toward the left ventricle. It supports basic chamber and circulation terminology.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "left atrial chamber", termType: "clinical" }] },
  { id: "structure-left-ventricle", slug: "left-ventricle", name: "Left Ventricle", structureType: "heart_chamber", region: "thorax", systemSlug: "cardiovascular", systemConceptSlug: "cardiovascular-system", description: "The left ventricle is a heart chamber that pumps blood into systemic circulation. It anchors simple cardiovascular flow education without adding diagnostic cardiology content.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "left ventricular chamber", termType: "clinical" }] },
  ...
  { id: "structure-bronchiole", slug: "bronchiole", name: "Bronchiole", structureType: "airway", region: "thorax", systemSlug: "respiratory", systemConceptSlug: "respiratory-system", description: "A bronchiole is a smaller branching airway that conducts air within lung tissue toward gas-exchange regions. It fills the textbook bridge between bronchi and alveoli.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "small airway", termType: "common" }] },
  ...
  { id: "structure-duodenum", slug: "duodenum", name: "Duodenum", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The duodenum is the first small-intestine segment and receives digestive contents from the stomach along with accessory digestive secretions. It deepens digestive tract coverage.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "first small intestine segment", termType: "common" }] },
  { id: "structure-jejunum", slug: "jejunum", name: "Jejunum", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The jejunum is a middle small-intestine segment associated with digestion and absorption. It gives the digestive system browser clearer small-intestine segmentation.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  { id: "structure-ileum", slug: "ileum", name: "Ileum", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The ileum is the distal small-intestine segment before the large intestine. It supports basic digestive tract continuity and abdomen-region education.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  ...
  { id: "structure-cecum", slug: "cecum", name: "Cecum", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The cecum is the first pouch-like region of the large intestine near the ileum. It provides a basic landmark for large-intestine organization.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "caecum", termType: "alternate" }] },
  { id: "structure-colon", slug: "colon", name: "Colon", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The colon is the major large-intestine region between the cecum and rectum. It helps connect common client language with digestive-system anatomy.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "large bowel", termType: "common" }] },
  { id: "structure-appendix", slug: "appendix", name: "Appendix", structureType: "digestive_tract", region: "abdomen", systemSlug: "digestive", systemConceptSlug: "digestive-system", description: "The appendix is a small digestive tract structure attached to the cecum. It is included for basic abdominal anatomy orientation and system completeness.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "vermiform appendix", termType: "formal" }] },
  ...
  { id: "structure-hypothalamus", slug: "hypothalamus", name: "Hypothalamus", structureType: "endocrine_neural_region", region: "head", systemSlug: "endocrine", systemConceptSlug: "endocrine-system", description: "The hypothalamus is a brain region that links nervous-system regulation with endocrine control. It supports textbook endocrine coverage without replacing detailed neuroanatomy.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  ...
  { id: "structure-pineal-gland", slug: "pineal-gland", name: "Pineal Gland", structureType: "endocrine_gland", region: "head", systemSlug: "endocrine", systemConceptSlug: "endocrine-system", description: "The pineal gland is an endocrine gland in the brain region associated with hormone secretion and circadian physiology. It adds standard endocrine gland coverage.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  ...
  { id: "structure-glomerulus", slug: "glomerulus", name: "Glomerulus", structureType: "microscopic_filtering_unit", region: "abdomen", systemSlug: "urinary", systemConceptSlug: "urinary-system", description: "A glomerulus is a capillary network within the nephron involved in filtration. It adds textbook nephron detail without requiring a full renal histology atlas.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "kidney filter tuft", termType: "common" }] },
  { id: "structure-renal-tubule", slug: "renal-tubule", name: "Renal Tubule", structureType: "microscopic_tubule", region: "abdomen", systemSlug: "urinary", systemConceptSlug: "urinary-system", description: "A renal tubule is a nephron passage where filtrate is modified through reabsorption and secretion. It supports urinary physiology terms used in education.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "kidney tubule", termType: "common" }] },
  { id: "structure-renal-pelvis", slug: "renal-pelvis", name: "Renal Pelvis", structureType: "urine_collecting_region", region: "abdomen", systemSlug: "urinary", systemConceptSlug: "urinary-system", description: "The renal pelvis is a kidney collecting region that funnels urine toward the ureter. It completes the high-level urinary pathway from nephron to ureter.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "kidney pelvis", termType: "common" }] },
  ...
  { id: "structure-cervix", slug: "cervix", name: "Cervix", structureType: "reproductive_tract", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "The cervix is the lower region of the uterus that connects with the vagina. It adds a standard reproductive tract landmark for pelvic anatomy education.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "uterine cervix", termType: "clinical" }] },
  ...
  { id: "structure-vulva", slug: "vulva", name: "Vulva", structureType: "external_reproductive_region", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "The vulva is the external female reproductive region. It supports neutral reproductive anatomy vocabulary without adding clinical examination content.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "external female genitalia", termType: "clinical" }] },
  { id: "structure-clitoris", slug: "clitoris", name: "Clitoris", structureType: "external_reproductive_organ", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "The clitoris is an external reproductive organ with erectile tissue. It is included for complete, neutral reproductive anatomy terminology.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  ...
  { id: "structure-seminal-vesicle", slug: "seminal-vesicle", name: "Seminal Vesicle", structureType: "reproductive_gland", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "A seminal vesicle is an accessory reproductive gland that contributes fluid to semen. It fills a common male reproductive-system textbook gap.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  { id: "structure-bulbourethral-gland", slug: "bulbourethral-gland", name: "Bulbourethral Gland", structureType: "reproductive_gland", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "A bulbourethral gland is an accessory reproductive gland associated with the male reproductive tract. It supports complete accessory-gland vocabulary.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE, terms: [{ term: "Cowper gland", termType: "eponym" }] },
  ...
  { id: "structure-scrotum", slug: "scrotum", name: "Scrotum", structureType: "external_reproductive_region", region: "pelvis", systemSlug: "reproduction", systemConceptSlug: "reproductive-system", description: "The scrotum is an external reproductive structure that contains the testes. It rounds out basic male reproductive gross anatomy terminology.", sourceRef: TEXTBOOK_TAXONOMY_SOURCE },
  ...
  { id: "structure-eye", slug: "eye", name: "Eye", structureType: "sensory_organ", region: "face", systemSlug: "nervous", systemConceptSlug: "nervous-system", description: "The eye is a sensory organ for vision. It is included for nervous-system special-senses anatomy and client-friendly head and face education.", sourceRef: SOURCE, terms: [{ term: "visual organ", termType: "clinical" }] },
  { id: "structure-retina", slug: "retina", name: "Retina", structureType: "sensory_tissue", region: "face", systemSlug: "nervous", systemConceptSlug: "nervous-system", description: "The retina is nervous sensory tissue at the back of the eye that receives light information. It supports visual-system anatomy terminology.", sourceRef: SOURCE, terms: [{ term: "light-sensitive layer", termType: "common" }] },
  { id: "structure-ear", slug: "ear", name: "Ear", structureType: "sensory_organ", region: "head", systemSlug: "nervous", systemConceptSlug: "nervous-system", description: "The ear is a sensory organ associated with hearing and balance. It supports nervous-system special-senses anatomy and head-region education.", sourceRef: SOURCE, terms: [{ term: "hearing organ", termType: "common" }] },
  { id: "structure-cochlea", slug: "cochlea", name: "Cochlea", structureType: "sensory_tissue", region: "head", systemSlug: "nervous", systemConceptSlug: "nervous-system", description: "The cochlea is an inner-ear nervous-system structure involved in hearing. It anchors auditory anatomy without implying clinical testing or diagnosis.", sourceRef: SOURCE, terms: [{ term: "hearing spiral", termType: "common" }] },
  { id: "structure-vestibular-apparatus", slug: "vestibular-apparatus", name: "Vestibular Apparatus", structureType: "sensory_tissue", region: "head", systemSlug: "nervous", systemConceptSlug: "nervous-system", description: "The vestibular apparatus is an inner-ear nervous-system region associated with balance and head-motion information. It supports balance and proprioception-adjacent education.", sourceRef: SOURCE, terms: [{ term: "balance organ", termType: "common" }] },

  { id: "structure-superficial-fascia", slug: "superficial-fascia", name: "Superficial Fascia", structureType: "fascia", region: "body-surface", systemSlug: "muscular", systemConceptSlug: "muscular-system", description: "Superficial fascia is connective tissue beneath the skin that helps organize superficial vessels, nerves, fat, and soft tissue mobility. It supports massage-relevant gross anatomy.", sourceRef: SOURCE, terms: [{ term: "subcutaneous fascia", termType: "clinical" }] },
  { id: "structure-deep-fascia", slug: "deep-fascia", name: "Deep Fascia", structureType: "fascia", region: "trunk-spine-pelvis", systemSlug: "muscular", systemConceptSlug: "muscular-system", description: "Deep fascia is connective tissue that invests muscles, forms compartments, and transmits force. It supports anatomy education about fascia without overstating treatment claims.", sourceRef: SOURCE, terms: [{ term: "investing fascia", termType: "clinical" }] },
  { id: "structure-joint-capsule", slug: "joint-capsule", name: "Joint Capsule", structureType: "joint_capsule", region: "trunk-spine-pelvis", systemSlug: "skeletal", systemConceptSlug: "skeletal-system", description: "A joint capsule is connective tissue surrounding a synovial joint. It helps organize joint stability, synovial membrane, ligament, and range-of-motion education.", sourceRef: SOURCE, terms: [{ term: "articular capsule", termType: "formal" }] },
  { id: "structure-synovial-membrane", slug: "synovial-membrane", name: "Synovial Membrane", structureType: "joint_membrane", region: "trunk-spine-pelvis", systemSlug: "skeletal", systemConceptSlug: "skeletal-system", description: "The synovial membrane lines parts of a synovial joint capsule and is associated with synovial fluid production. It supports joint structure and movement education.", sourceRef: SOURCE, terms: [{ term: "synovium", termType: "clinical" }] },
  { id: "structure-articular-cartilage", slug: "articular-cartilage", name: "Articular Cartilage", structureType: "cartilage", region: "trunk-spine-pelvis", systemSlug: "skeletal", systemConceptSlug: "skeletal-system", description: "Articular cartilage covers bone surfaces within many joints and helps reduce friction during movement. It supports joint structure, ROM, and education prompts.", sourceRef: SOURCE, terms: [{ term: "joint cartilage", termType: "common" }] },
  { id: "structure-bursa", slug: "bursa", name: "Bursa", structureType: "bursa", region: "trunk-spine-pelvis", systemSlug: "skeletal", systemConceptSlug: "skeletal-system", description: "A bursa is a small fluid-associated sac that can reduce friction between moving tissues. It is included as a gross anatomy structure, not as a diagnosis.", sourceRef: SOURCE, terms: [{ term: "friction-reducing sac", termType: "common" }] },
]
...
function conceptCitation(concept: AnatomyConcept): AnatomyCitation {
  const isTissueType = concept.conceptType === "tissue_type"
  ...
  return {
    ...
    sourceRef: concept.sourceRef,
    sourceLocator: isTissueType ? TISSUE_TYPE_LOCATOR : BODY_SYSTEM_LOCATOR,
    citationNote: isTissueType
      ? "Reviewed commercial-compatible support for MassageLab-authored tissue-type taxonomy summary. Do not copy source prose directly."
      : "Reviewed commercial-compatible support for MassageLab-authored body-system summary. Do not copy source prose directly.",
...
function structureCitation(structure: StructureSpec): AnatomyCitation {
  return {
    ...
    sourceRef: structure.sourceRef,
    sourceLocator: BODY_SYSTEM_LOCATOR,
...
function subsystemRelationship(concept: AnatomyConcept): AnatomyRelationship {
  return {
    id: `relationship-${concept.slug}-subsystem-of-musculoskeletal`,
    sourceEntityType: "anatomy_concept",
    sourceEntitySlug: concept.slug,
    relationshipType: "subsystem_of",
    targetEntityType: "anatomy_concept",
    targetEntitySlug: MUSCULOSKELETAL_SYSTEM_CONCEPT.slug,
    sourceRef: concept.sourceRef,
  }
}
...
export const GROSS_BODY_SYSTEM_STRUCTURES_SECTION: AnatomySeedSection = {
  ...
  concepts: [
    ...BODY_SYSTEM_CONCEPTS,
    ...TISSUE_TYPE_CONCEPTS,
  ],
  structures: STRUCTURES.map(structureSeedRecord),
  entityTerms: [
    ...BODY_SYSTEM_CONCEPTS.map(conceptTerm),
    ...TISSUE_TYPE_CONCEPTS.map(conceptTerm),
    ...STRUCTURES.flatMap(structureTerms),
  ],
  relationships: [
    subsystemRelationship(SKELETAL_SYSTEM_CONCEPT),
    subsystemRelationship(MUSCULAR_SYSTEM_CONCEPT),
    ...STRUCTURES.map(systemRelationship),
  ],
  citations: [
    ...BODY_SYSTEM_CONCEPTS.map(conceptCitation),
    ...TISSUE_TYPE_CONCEPTS.map(conceptCitation),
