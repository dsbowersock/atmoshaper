...
const MUSCLE_ACTIONS: MuscleActionRow[] = MUSCLE_SPECS.flatMap((spec) => spec.actions.map((action, index) => ({
  id: action.id ?? `action-atlas-complete-${spec.slug}-${action.movement}-${index + 1}`,
  muscle: spec.slug,
  joint: action.joint,
...
const LIGAMENT_SPECS: LigamentSpec[] = [
  ...
  { slug: "dorsal-tarsometatarsal-ligaments", name: "Dorsal Tarsometatarsal Ligaments", formalName: "Ligamenta tarsometatarsalia dorsalia", alternateNames: ["dorsal midfoot ligaments"], region: "foot", joint: "tarsometatarsal-joints", summary: "Dorsal midfoot ligaments connecting tarsal and metatarsal bones for arch and midfoot support.", relationshipType: "supports", targetEntityType: "region", targetEntitySlug: "foot" },
  { slug: "plantar-tarsometatarsal-ligaments", name: "Plantar Tarsometatarsal Ligaments", formalName: "Ligamenta tarsometatarsalia plantaria", alternateNames: ["plantar midfoot ligaments"], region: "foot", joint: "tarsometatarsal-joints", summary: "Plantar midfoot ligaments connecting tarsal and metatarsal bones for plantar arch support.", relationshipType: "supports", targetEntityType: "region", targetEntitySlug: "foot" },
]
