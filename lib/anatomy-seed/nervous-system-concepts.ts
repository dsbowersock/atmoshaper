...
const CONCEPTS: ConceptSpec[] = [
  { id: "concept-nervous-system", slug: "nervous-system", name: "Nervous System", conceptType: "system_structure", bodySystem: "nervous", description: "The nervous system includes the brain, spinal cord, nerves, sensory receptors, and supporting cells that coordinate signaling and body responses. AtmoShaper uses this as broad A&P context, not diagnostic neurology.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  ...
  { id: "concept-sympathetic-division", slug: "sympathetic-division", name: "Sympathetic Division", conceptType: "system_function", bodySystem: "nervous", description: "The sympathetic division is an autonomic nervous-system subdivision associated with mobilizing body responses. AtmoShaper represents it as physiology education without making treatment claims.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
