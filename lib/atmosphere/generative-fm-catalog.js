...
const GENERATIVE_FM_LISTENER_DESCRIPTIONS = Object.freeze({
  ...
  awash:
    "A darker ocean-drum and guitar wash with distorted, voice-like edges for experimental atmospheres.",
  "beneath-waves":
    "Soft choir and oboe-like tones create an underwater-style haze, with little literal wave sound.",
  bhairav:
  ...
  "little-bells":
    "Very sparse high bell tones appear with long quiet gaps and airy reverb.",
  lullaby:
  ...
  moment:
    "Guitar-centered ambient tones with faint human-like color create a close, quiet bed.",
  nakaii:
    "Sustained strings move slowly in a calm, spacious wash.",
  neuroplasticity:
    "Guitar and piano tones with voice-like artifacts create a darker, more experimental texture.",
  "no-refrain":
...
/**
 * Builds AtmoShaper station entries for every installed Generative.fm piece.
