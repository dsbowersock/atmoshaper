...
const anonymousQuickActions = Object.freeze([
  { id: "login", label: "Log In", description: `Sign in to ${PUBLIC_PRODUCT_IDENTITY.name}.`, href: "/login", icon: "LogIn" },
  { id: "create_account", label: "Create Account", description: `Register an ${PUBLIC_PRODUCT_IDENTITY.name} account.`, href: "/register", icon: "UserPlus" },
