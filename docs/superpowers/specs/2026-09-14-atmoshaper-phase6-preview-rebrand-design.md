...
Historical PR #5 source status (not replacement Task 9 or PNG clearance; see [project state](../../project-state.md)): approved by the user on 2026-09-14, including the legal-identity and
