...
| [0002: Public identity, legal and compatibility](0002-public-identity-legal-and-compatibility-boundaries.md) | Proposed pending final integration | Phase 6 AtmoShaper/Atmosphere presentation and versioned legal transition are implemented in the reviewed recovery source and replacement stack; final source equivalence, Task 9 review and hosted gates are pending. Historical acceptances, provider boundaries and durable identifiers remain preserved. | Accept after Task 9 integration proof; revisit for a dedicated identifier migration, provider-visible change, external legal filing claim, domain cutover or approved-logo integration. |
