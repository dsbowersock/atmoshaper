...
| [0002: Public identity, legal and compatibility](0002-public-identity-legal-and-compatibility-boundaries.md) | Accepted | AtmoShaper/Atmosphere current presentation and versioned legal transition are locally implemented, command-verified, and reviewed through systemic owner-repair head `75e2741`; archived/accepted legal records, endpoints, providers, and durable identifiers remain preserved. | Revisit for a dedicated identifier migration, provider-visible change, external legal filing claim, domain cutover, or approved-logo integration. Task 9 cleanup, final receipt-only baseline fixed point, and complete-branch reviews are complete; coordinator commit remains the repository-integration gate. |
