...
| [0002: Public identity, legal and compatibility](0002-public-identity-legal-and-compatibility-boundaries.md) | Proposed | AtmoShaper/Atmosphere current presentation and versioned legal transition; preserve archived/accepted legal records, endpoints, providers, and durable identifiers. | Complete Phase 6 implementation/verification, a dedicated identifier migration, external legal filing claim, or approved logo integration. |
