...
## Historical Phase 1 Baseline and Non-Negotiable Preservation

The original Phase 1 selection was source repository `https://github.com/dsbowersock/massagelab` at `main` SHA `fa78ca01a42179329cc223df77c76f308e76320b` (2026-09-06). That SHA is historical, not the Phase 2 export source; the [export manifest](atmoshaper-export-manifest.json) and [charter](atmoshaper-migration-charter.md) own the current lock. The old repository remains unchanged, accessible, and authoritative for historical evidence and rollback. No rollback action may rewrite its history, remove historical material, archive it, change its visibility, or alter its production service without separate authorization.
...
- The MassageLab repository, its Git history, the manifest-owned current source commit, historical Phase 1 SHA `fa78ca01a42179329cc223df77c76f308e76320b`, and current production service remain untouched throughout this rollback.
