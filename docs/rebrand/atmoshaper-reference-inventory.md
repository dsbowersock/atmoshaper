...
Authority: [charter](atmoshaper-migration-charter.md), [approved design](../superpowers/specs/2026-09-06-atmoshaper-repository-migration-design.md), [bootstrap plan](../superpowers/plans/2026-09-06-atmoshaper-repository-migration.md), [completed local Phase 3 plan](../superpowers/plans/2026-09-09-atmoshaper-phase3-documentation-consolidation.md), and [rollback plan](atmoshaper-rollback-plan.md). This document retains the Task 2 classification contract and accepted Task 3/4 source, Task 7 destination, and Task 9 publication receipts. The current Phase 3 update below supersedes their timing and next-action statements; historical source/initial-tree counts and dated provider receipts are preserved.
...
Phase 3 is complete locally on `codex/atmoshaper-docs-consolidation`, based on that merge. Tasks 1–3 are committed (`99a1faa`, `7be78ff`, `49fba96`), Task 4 authority synchronization is complete at `7daec8142d0353b33f5aaeabcccb7689f15c820b`, and Task 5 completes the deterministic audit reconciliation and closeout evidence in the commit containing this receipt. The branch has not been pushed, no Phase 3 pull request has been opened, and Phase 4 has not started.
...
Runtime/public rebrand, dedicated old-origin recovery, provider staging, deployment, DNS/domain, production/database/payment/email/media, and legal changes remain future gated work. No unrelated provider observations were refreshed by this documentation synchronization. [Project state](../project-state.md) owns the current separate publication gate.
