...
- **Signature original eligible:** No
- **Rationale:** Skybreak gives the passive top-down shafts a calm sense of height while remaining faithful to their diffuse overhead form.
- **Collision notes:** The overhead diffuse origin keeps it apart from Lateral Rays, Cascading Rays, Spotlight, and Lamp Glow.

## DNA
- **ID:** `massage-lab-dna`
- **Current name:** DNA
- **Decision:** keep
- **Alternatives:** Helix Rhythm; Genetic Geometry
- **Visual descriptor:** Double helices rotating in depth
- **Signature original eligible:** No
- **Rationale:** DNA is the most truthful and scannable name for the reviewed paired-base helix, while remaining descriptive rather than making a health claim.
- **Collision notes:** The biological base-pair structure is unique; Hypercube also rotates in depth but has no organic or educational form.
...
- **Current name:** Lamp Glow
- **Decision:** keep
- **Alternatives:** Centered Canopy; Quiet Beacon
...
- **Current name:** Spotlight
- **Decision:** keep
- **Alternatives:** Twin Illumination; Theater Sweep
- **Visual descriptor:** Mirrored light cones sweeping through darkness
- **Signature original eligible:** No
- **Rationale:** Spotlight is a familiar, readable term for the paired theatrical cones and needs no decorative wording to fit the restorative collection.
- **Collision notes:** The mirrored cones distinguish this option from Lamp Glow's centered canopy and Skybreak's soft overhead wash.
