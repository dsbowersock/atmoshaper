...
describe("confirmPasswordReset", () => {
  ...
  it("commits the complete successful password-reset bundle", async () => {
    ...
    assert.deepEqual(state.emailIntents[0], {
      ...
      subject: "Password sign-in added or replaced for your AtmoShaper account",
      message: "Password sign-in was added or replaced for your AtmoShaper account. This can add email and password to an existing account, or replace an existing password. Existing sign-in methods remain connected. If you made this change, no action is needed. If you did not, contact support. You may receive this notice more than once if delivery had to be retried.",
