...
describe("proprietary repository licensing", () => {
  it("keeps every public repository surface explicitly proprietary", async () => {
    ...
    assert.match(
      readme,
      /codebase remains source-visible proprietary software, not open-source software/i,
    )
    assert.match(
      readme,
      /Copyright © 2025–2026 Derrick Bowersock, doing business as Massage Lab\. All rights reserved\./,
    ...
    assert.match(
      readme,
      /Public repository access does not grant permission to reuse, modify, or redistribute owner-controlled source code or assets/i,
    )
