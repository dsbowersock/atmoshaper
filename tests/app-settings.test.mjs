...
describe("App settings helpers", () => {
  ...
  it("keeps the mobile main bar controls styled as physical buttons", () => {
    ...
    assert.match(toolLinkSource, /className="ml-main-bar-button-label"/)
    assert.match(mainBarSource, /<span className="ml-main-bar-button-label">More<\/span>/)
    assert.match(globalsSource, /\.ml-main-bar-button \.ml-main-bar-button-label \{[\s\S]*display: none/)
    assert.doesNotMatch(globalsSource, /\.ml-main-bar-button span:not\(\.sr-only\)/)
